...
func (_mock *MockWAL[T]) Propose(proposal types.WALEntry[T]) error {
...
//   - proposal types.WALEntry[T]
func (_e *MockWAL_Expecter[T]) Propose(proposal interface{}) *MockWAL_Propose_Call[T] {
	return &MockWAL_Propose_Call[T]{Call: _e.mock.On("Propose", proposal)}
}

func (_c *MockWAL_Propose_Call[T]) Run(run func(proposal types.WALEntry[T])) *MockWAL_Propose_Call[T] {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockWAL_Propose_Call[T]) RunAndReturn(run func(proposal types.WALEntry[T]) error) *MockWAL_Propose_Call[T] {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockWAL[T]) Watch() (<-chan []T, func()) {
	ret := _mock.Called()
...
func (_c *MockWAL_Watch_Call[T]) Return(vsCh <-chan []T, fn func()) *MockWAL_Watch_Call[T] {
	_c.Call.Return(vsCh, fn)
	return _c
}

func (_c *MockWAL_Watch_Call[T]) RunAndReturn(run func() (<-chan []T, func())) *MockWAL_Watch_Call[T] {
	_c.Call.Return(run)
	return _c
}
